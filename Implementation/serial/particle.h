...
void get_orbital_velocity(const Particle *central, Particle *satellite);
/**
 * Generate a random particle in the given space.
 */
void generate_random_particles(Particle * p, Space s, int count, float galaxy_diameter, float galaxy_thickness);
...
double compute_distance_squared(Particle *particle, double com_x, double com_y, double com_z);
