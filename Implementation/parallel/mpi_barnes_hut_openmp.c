/******************************************************************************
* Hybrid MPI/OpenMP implementation of the Barnes-Hut algorithm for N-body simulation.
* To compile: mpicc -fopenmp mpi_barnes_hut_openmp.c particle.c octree.c timer.c -o mpi-barnes-hut-openmp -lm
* To run: srun ./mpi-barnes-hut-openmp NUM_PARTICLES NUM_TIMESTEPS
******************************************************************************/
#include "mpi.h"
#include <stdio.h>
#include <stdlib.h>
...
int main(int argc, char *argv[]) {
    ...
    for (int i = 0; i < t_step; i++) {
        ...
        // Parallelize the insertion of particles into the octree
        ...
        // Each process processes its chunk of particles.
